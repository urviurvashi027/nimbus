...
import { Skeleton } from "@/features/check-in/components/reading/SkeletonCard";
import { ErrorCard } from "@/features/check-in/components/reading/ErrorCard";
...
export const ReadingCheckInScreen = () => {
  ...
  // ---------- derive UI data
  const { goalMin, completedMin, progressPct, weeklySeries, avg } =
    useMemo(() => {
